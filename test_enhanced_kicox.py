...
# -*- coding: utf-8 -*-
"""
KICOX Enhanced 스크래퍼 테스트 스크립트
"""

import os
import sys
import logging
from enhanced_kicox_scraper import EnhancedKicoxScraper
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('kicox_test.log', encoding='utf-8')
    ]
)

logger = logging.getLogger(__name__)

def test_kicox_scraper(pages=3):
    """KICOX 스크래퍼 테스트"""
    logger.info("=== KICOX Enhanced 스크래퍼 테스트 시작 ===")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='KICOX 스크래퍼 테스트')
    ...
    test_kicox_scraper(pages=test_pages)
# -*- coding: utf-8 -*-
"""
GMCCI(광명상공회의소) 스크래퍼 - Enhanced 버전
"""
    ...
    def parse_list_page(self, html_content: str) -> list:
        ...
        for row in data_rows:
            try:
                ...
                # 상세 페이지 URL 구성
                detail_url = f"{self.detail_base_url}?contentsId={content_id}&boardId=10599&menuId=2022"
...
# 테스트용 함수
def test_gmcci_scraper(pages=3):
    """GMCCI 스크래퍼 테스트"""
    import os
    ...
    scraper = EnhancedGMCCIScraper()
    output_dir = "output/gmcci"
    os.makedirs(output_dir, exist_ok=True)
    
    logger.info(f"GMCCI 스크래퍼 테스트 시작 - {pages}페이지")
    scraper.scrape_pages(max_pages=pages, output_base=output_dir)
    logger.info("GMCCI 스크래퍼 테스트 완료")

if __name__ == "__main__":
    test_gmcci_scraper(3)
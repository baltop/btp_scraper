# -*- coding: utf-8 -*-
"""
BucheonCCI(부천상공회의소) 스크래퍼 - Enhanced 버전
"""
...
class EnhancedBucheonCCIScraper(StandardTableScraper):
    """부천상공회의소 공지사항 스크래퍼 - 향상된 버전"""
    
    def __init__(self):
        super().__init__()
        self.base_url = "https://bucheoncci.korcham.net"
        self.list_url = "https://bucheoncci.korcham.net/front/board/boardContentsListPage.do?boardId=10135&menuId=410"
        ...
        self.detail_base_url = "https://bucheoncci.korcham.net/front/board/boardContentsView.do"
    ...
    def parse_list_page(self, html_content: str) -> list:
        ...
        for row in data_rows:
            try:
                ...
                content_id = None
                if onclick:
                    # javascript:contentsView('114617') 형태에서 ID 추출
...
# 테스트용 함수
def test_bucheoncci_scraper(pages=3):
    """BucheonCCI 스크래퍼 테스트"""
    import os
    ...
    scraper = EnhancedBucheonCCIScraper()
    output_dir = "output/bucheoncci"
    os.makedirs(output_dir, exist_ok=True)
    
    logger.info(f"BucheonCCI 스크래퍼 테스트 시작 - {pages}페이지")
    scraper.scrape_pages(max_pages=pages, output_base=output_dir)
    logger.info("BucheonCCI 스크래퍼 테스트 완료")

if __name__ == "__main__":
    test_bucheoncci_scraper(3)
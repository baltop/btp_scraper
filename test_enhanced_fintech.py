...
def test_fintech_scraper(pages=3, output_dir="output/fintech"):
    """용인상공회의소 스크래퍼 테스트"""
...
def main():
    ...
    parser.add_argument('--output', type=str, default='output/fintech', help='출력 디렉토리')
    ...
    try:
        test_fintech_scraper(pages=pages, output_dir=args.output)

...
def test_gbsinbo_scraper(pages=3, output_dir="output/gbsinbo"):
    """용인상공회의소 스크래퍼 테스트"""
    ...
    try:
        ...
        logger.info(f"=== Fintech 스크래퍼 테스트 시작 ===")
        ...
        logger.info(f"=== fintech 스크래퍼 테스트 완료 ===")
...
def main():
    ...
    parser.add_argument('--output', type=str, default='output/gbsinbo', help='출력 디렉토리')
    ...
    try:
        test_gbsinbo_scraper(pages=pages, output_dir=args.output)

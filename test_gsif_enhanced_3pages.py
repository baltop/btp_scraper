...
# -*- coding: utf-8 -*-
"""
Enhanced GSIF 스크래퍼 3페이지 전체 테스트
output/gsif_enhanced 디렉토리에 저장
"""
...
def test_gsif_3pages():
    """GSIF 스크래퍼 3페이지 테스트"""
    print("=== Enhanced GSIF 스크래퍼 3페이지 테스트 ===")
    
    # 스크래퍼 인스턴스 생성
    scraper = EnhancedGSIFScraper()
    
    # 출력 디렉토리 설정
    output_dir = "output/gsif_enhanced"
    ...
    for folder in folders:
        ...
        if os.path.exists(content_path):
            ...
            with open(content_path, 'r', encoding='utf-8') as f:
                content = f.read()
                if '**원본 URL**:' in content and 'mybiz.gsipa.or.kr' in content:
                    url_check_passed += 1

...
# -*- coding: utf-8 -*-
"""
UBPI Enhanced 스크래퍼 테스트 스크립트
"""

import os
import sys
import logging
from enhanced_ubpi_scraper import EnhancedUbpiScraper
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('ubpi_test.log', encoding='utf-8')
    ]
)

logger = logging.getLogger(__name__)

def test_ubpi_scraper(pages=3):
    """UBPI 스크래퍼 테스트"""
    logger.info("=== UBPI Enhanced 스크래퍼 테스트 시작 ===")
    
    # 출력 디렉토리 설정
    output_dir = "output/ubpi"
    os.makedirs(output_dir, exist_ok=True)
    
    # 스크래퍼 초기화
    scraper = EnhancedUbpiScraper()
    ...
    for folder_name in announcement_folders:
        ...
        if os.path.exists(content_file):
            ...
            try:
                ...
                # 원본 URL 포함 확인
                if '**원본 URL**:' in content and 'ubpi.or.kr' in content:
                    url_check_passed += 1
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='UBPI 스크래퍼 테스트')
    ...
    test_ubpi_scraper(pages=test_pages)
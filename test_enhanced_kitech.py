...
# -*- coding: utf-8 -*-
"""
KITECH Enhanced 스크래퍼 테스트 스크립트
"""

import os
import sys
import logging
from enhanced_kitech_scraper import EnhancedKitechScraper
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('kitech_test.log', encoding='utf-8')
    ]
)

logger = logging.getLogger(__name__)

def test_kitech_scraper(pages=3):
    """KITECH 스크래퍼 테스트"""
    logger.info("=== KITECH Enhanced 스크래퍼 테스트 시작 ===")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='KITECH 스크래퍼 테스트')
    ...
    test_kitech_scraper(pages=test_pages)